          ...
          <div class="d-flex flex-column h-100">
            ...
            <div class="d-flex align-center pa-4 border-b border-white-5">
              ...
              <div>
                ...
                <div class="text-caption text-blue-lighten-3 font-weight-bold" style="font-size: 10px; letter-spacing: 1px;">DATA AGENT</div>
              </div>
            </div>
            ...
            <v-list density="compact" nav class="flex-grow-1 pa-2 px-4 custom-scrollbar bg-transparent" theme="dark">
              ...
              <v-list-group value="knowledge">
                ...
                <v-list-item prepend-icon="mdi-book-open-variant" title="业务知识配置" @click="navigateToPath('/knowledge/business')" :active="isActive('/knowledge/business')" density="compact" class="rounded-lg mb-1 navigation-sub-item" />
                <v-list-item prepend-icon="mdi-brain" title="智能体知识库" @click="navigateToPath('/knowledge/agents')" :active="isActive('/knowledge/agents')" density="compact" class="rounded-lg mb-1 navigation-sub-item" />
                <v-list-item prepend-icon="mdi-vector-intersection" title="语义模型配置" @click="navigateToPath('/knowledge/semantic-models')" :active="isActive('/knowledge/semantic-models')" density="compact" class="rounded-lg mb-1 navigation-sub-item" />
              </v-list-group>
              ...
              <v-list-group value="system">
                ...
                <v-list-item prepend-icon="mdi-database-refresh-outline" title="数据连接" @click="navigateToPath('/system/data-sources')" :active="isActive('/system/data-sources')" density="compact" class="rounded-lg mb-1 navigation-sub-item" />
                <v-list-item prepend-icon="mdi-cpu-64-bit" title="模型配置" @click="navigateToPath('/system/model-config')" :active="isActive('/system/models')" density="compact" class="rounded-lg mb-1 navigation-sub-item" />
                <v-list-item prepend-icon="mdi-cog-outline" title="通用设置" @click="navigateToPath('/system/settings')" :active="isActive('/system/settings')" density="compact" class="rounded-lg mb-1 navigation-sub-item" />
              </v-list-group>
              ...
              <div class="mt-6 pt-4 border-t border-white/5">
                <v-list-item 
                  ...
                  color="white"
                >
                  <template v-slot:prepend><v-icon icon="mdi-plus-box-outline" class="mr-3"></v-icon></template>
            ...
            <div class="pa-4 border-t border-white/5">
              <v-btn block variant="text" color="red-lighten-2" class="text-none justify-start px-2 d-flex align-center" @click="logout">
                <template v-slot:prepend>
                  <v-avatar size="24" color="grey-darken-3" class="mr-2"><v-icon icon="mdi-account" size="14"></v-icon></v-avatar>
                </template>
...
const currentRouteTitle = computed(() => routeTitleMap[route.path] || 'Data Agent');
